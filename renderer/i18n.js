...
const DICT = {
  'zh-TW': {
    ...
    sPillProvider: '收合時顯示',
    sPillAuto: '自動（最需注意）',
    sPillHint: '金額型供應商以 US$100 = 100% 換算，超過 US$100 時封頂顯示 100%。',
    allFail: '暫時無法讀取所有供應商',
    pillUpd: (v) => `更新 ${v.ago}`,
  },
  en: {
    ...
    sPillProvider: 'Collapsed display',
    sPillAuto: 'Auto (needs attention)',
    sPillHint: 'Money providers use US$100 = 100%, capped at 100% above US$100.',
