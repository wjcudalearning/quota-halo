...
const DICT = {
  'zh-TW': {
    ...
    sPolling: '輪詢 Polling',
    sAbout: '關於 About',
    sOpenrouterKey: 'OpenRouter Management API 金鑰',
    sCredFile: 'DeepSeek 憑證檔案（YAML）',
    sBrowse: '瀏覽…',
    sKeyName: '該檔案內的金鑰名稱',
    sCredHint: '預設 ~/.dsh/.credentials.yaml，預設讀取 DEEPSEEK_API_KEY。',
    sOrHint: '要讀帳號餘額請使用 Management API 金鑰；一般 inference 金鑰只能讀自己的限額。金鑰存於本機設定，也可設 OPENROUTER_API_KEY 環境變數。',
    sOrVerify: '驗證連線',
    sOrCreate: '到 OpenRouter 建立管理金鑰…',
    sOrClear: '清除',
    sEdge: '螢幕邊緣',
    sEdgeTop: '上方',
    sEdgeBottom: '下方',
  ...
  en: {
    ...
    sPolling: 'Polling',
    sAbout: 'About',
    sOpenrouterKey: 'OpenRouter Management API key',
    ...
    sOrHint: 'Use a Management API key for account credit. A standard inference key can show only its own cap. Stored locally; OPENROUTER_API_KEY also works.',
    sOrVerify: 'Verify connection',
    sOrCreate: 'Create a Management API key at OpenRouter…',
    sOrClear: 'Clear',
    sEdge: 'Screen edge',
    sEdgeTop: 'Top',
    sEdgeBottom: 'Bottom',
